define(["jquery", "handlebarsBase", "Core/core-config", "Service/ajax-service", "Service/error-service", "Sandbox/sandbox", "Store/card-store", "bootstrap"],
function (iJquery, iHandlebars, iCoreConfig, iAjaxService, iErrorService, iSandbox, iCardStore) {

    var moduleData = {}, appConfig = {}, cardStore;

    return {
        start_all: function () {
            
            if (iJquery && iHandlebars && iCoreConfig && iAjaxService && iSandbox && iCardStore) {
        ...
        start: function (moduleId) {
            ...
            if (mod) {
                mod.instance = mod.create(iSandbox.create(this, moduleId), cardStore);
                mod.instance.init();
            }
        },
